...
/// - Scanning the network for other FileFlow instances
...
/// It just sends an announcement which will cause a response on every other FileFlow member of the network.
