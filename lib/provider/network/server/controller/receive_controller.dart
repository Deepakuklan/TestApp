...
import 'package:fileflow/common/model/dto/info_dto.dart';
import 'package:fileflow/common/model/dto/info_register_dto.dart';
import 'package:fileflow/common/model/dto/prepare_upload_request_dto.dart';
import 'package:fileflow/common/model/dto/prepare_upload_response_dto.dart';
import 'package:fileflow/common/model/dto/register_dto.dart';
import 'package:fileflow/common/model/file_status.dart';
import 'package:fileflow/common/model/file_type.dart';
import 'package:fileflow/common/model/session_status.dart';
import 'package:fileflow/model/state/send/send_session_state.dart';
import 'package:fileflow/model/state/server/receive_session_state.dart';
import 'package:fileflow/model/state/server/receiving_file.dart';
...
import 'package:fileflow/pages/receive_page_controller.dart';
import 'package:fileflow/provider/device_info_provider.dart';
import 'package:fileflow/provider/dio_provider.dart';
...
import 'package:fileflow/provider/network/server/controller/common.dart';
...
import 'package:fileflow/util/native/directories.dart';
import 'package:fileflow/util/native/file_saver.dart';
    ...
    server.setState(
      (oldState) => oldState?.copyWith(
        session: ReceiveSessionState(
          ...
          //     dto.files.values.every((f) {
          //       var contains = f.fileName.contains('/');
          //       return !contains;
          //     }),
          createdDirectories: {},
