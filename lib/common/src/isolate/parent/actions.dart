...
import 'parent_isolate_provider.dart';
import '../../util/id_provider.dart';
import '../../util/isolate_helper.dart';
import 'package:refena/refena.dart';

final _idProvider = IdProvider();

class IsolateTargetHttpDiscoveryAction extends AsyncReduxActionWithResult<
    IsolateController, ParentIsolateState, Device?> {
  final String ip;
  final int port;
  final bool https;
...
class IsolateInterfaceHttpDiscoveryAction extends ReduxActionWithResult<
    IsolateController, ParentIsolateState, Stream<Device>> {
...
class IsolateFavoriteHttpDiscoveryAction extends ReduxActionWithResult<
    IsolateController, ParentIsolateState, Stream<Device>> {
...
Stream<R> _sendTaskAndListenStream<R, T>({
  ...
  required IsolateConnector<IsolateTaskStreamResult<R>,
