...
import '../child/http_scan_discovery_isolate.dart';
import '../child/http_target_discovery_isolate.dart';
import '../child/main.dart';
import '../child/multicast_discovery_isolate.dart';
import '../child/sync_provider.dart';
import '../dto/isolate_task.dart';
import '../dto/isolate_task_result.dart';
import '../dto/isolate_task_stream_result.dart';
import '../dto/send_to_isolate_data.dart';
import '../../util/isolate_helper.dart';
...
class ParentIsolateState with ParentIsolateStateMappable {
  ...
  final IsolateConnector<IsolateTaskStreamResult<Device>,
      SendToIsolateData<IsolateTask<HttpScanTask>>>? httpScanDiscovery;
  final IsolateConnector<IsolateTaskResult<Device?>,
      SendToIsolateData<IsolateTask<HttpTargetTask>>>? httpTargetDiscovery;
...
class IsolateSetupAction
  ...
  Future<ParentIsolateState> reduce() async {
    final httpScanDiscovery = await startIsolate<
    ...
    final httpTargetDiscovery = await startIsolate<IsolateTaskResult<Device?>,
        SendToIsolateData<IsolateTask<HttpTargetTask>>, InitialData>(
    ...
    final multicastDiscovery =
        await startIsolate<Device, SendToIsolateData<Object>, InitialData>(
