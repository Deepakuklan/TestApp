...
class _StringsReceiveOptionsPageUk extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Папка FileFlow)';
  @override
...
class _StringsWebSharePageUk extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'FileFlow використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
  @override
...
class _StringsAboutPageUk extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Про FileFlow';
  @override
  List<String> get description => [
        'FileFlow — це безплатна програма з відкритим вихідним кодом, яка дозволяє вам безпечно обмінюватися файлами та повідомленнями з пристроями поблизу через локальну мережу, без необхідності підключення до Інтернету.',
...
class _StringsDonationPageUk extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'FileFlow — це безплатна програма з відкритим вихідним кодом та без реклами. Якщо вона вам подобається, ви можете підтримати її розробку пожертвою.';
  @override
...
class _StringsTrayUk extends _StringsTrayEn {
  ...
  @override
  String get close => 'Вийти з FileFlow';
  @override
...
class _StringsSettingsTabGeneralUk extends _StringsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Відображати FileFlow в контекстному меню';
  @override
...
class _StringsSettingsTabOtherUk extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Підтримати FileFlow';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedUk
  ...
  String get description =>
      'FileFlow не може знайти інші пристрої без дозволу на сканування локальної мережі. Будь ласка, надайте цей дозвіл у налаштуваннях.';
  @override
...
class _StringsDialogsQuickSaveFromFavoritesNoticeUk
  ...
  @override
  String get content =>
      'Запити на отримання файлів відтепер приймаються автоматично від пристроїв з вашого списку улюблених.';
}
...
class _StringsDialogsSendModeHelpUk extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Отримувачі, у яких не встановлено FileFlow, можуть завантажити вибрані файли, відкривши посилання у своєму браузері.';
}
