...
class _StringsReceiveOptionsPageZhCn extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(FileFlow 文件夹)';
  @override
...
class _StringsWebSharePageZhCn extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'FileFlow 使用自签名证书。您需要在浏览器中允许它。';
  @override
...
class _StringsAboutPageZhCn extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => '关于 FileFlow';
  @override
  List<String> get description => [
        'FileFlow 是一款免费的开源应用程序，可让您通过本地网络与附近的设备安全地分享文件和信息，而无需互联网连接。',
...
class _StringsDonationPageZhCn extends _StringsDonationPageEn {
  ...
  String get title => '捐赠';
  @override
  String get info => 'FileFlow 免费、开源、无广告。如果您喜欢这款应用程序，可以捐款支持开发。';
  @override
...
class _StringsSettingsTabGeneralZhCn extends _StringsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => '在“发送到”文件菜单中显示 FileFlow';
  @override
...
class _StringsSettingsTabOtherZhCn extends _StringsSettingsTabOtherEn {
  ...
  String get title => '其他';
  @override
  String get support => '支持 FileFlow';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedZhCn
  ...
  @override
  String get description => 'FileFlow 在没有扫描本地网络的权限的情况下无法找到其他设备。请在设置中授予此权限。';
  @override
...
class _StringsDialogsSendModeHelpZhCn extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link => '未安装 FileFlow 的接收者可以在浏览器中打开链接以下载选中的文件。';
}
