...
class _StringsWebSharePageSrCyrl extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'FileFlow користи сертификате који су self-signed. Морате да прихватите то у browseru.';
  @override
...
class _StringsAboutPageSrCyrl extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О FileFlow-у';
  @override
  List<String> get description => [
        'FileFlow је бесплатна (слободна) апликација отвореног кода, која Вам омогућава да делите фајлове и поруке са оближњим уређајима сигурно, преко локалне мреже, без потребе за интернет конекцијом.',
...
class _StringsDonationPageSrCyrl extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'FileFlow је слободна, апликација отвореног кода без реклама. Ако Вам се допада, можете подржати развој путем донације.';
  @override
...
class _StringsSettingsTabGeneralSrCyrl extends _StringsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Прикажи FileFlow у контекст менију';
  @override
...
class _StringsSettingsTabOtherSrCyrl extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Подржи FileFlow';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedSrCyrl
  ...
  String get description =>
      'FileFlow не може да нађе друге уређаје без дозволе да скенира локалну мрежу. Молим додајте ову дозволу у Подешавања.';
  @override
...
class _StringsDialogsSendModeHelpSrCyrl extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Примаоци који немају FileFlow инсталиран, могу да преузму селектоване фајлове преко Линка у browseru.';
}
