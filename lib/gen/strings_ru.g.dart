...
class _StringsWebSharePageRu extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'FileFlow использует самоподписанный сертификат. Вам необходимо принять его в браузере.';
  @override
...
class _StringsAboutPageRu extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О FileFlow';
  @override
  List<String> get description => [
        'FileFlow — это бесплатное приложение с открытым исходным кодом, которое позволяет вам безопасно обмениваться файлами и сообщениями с находящимися поблизости устройствами через локальную сеть, без необходимости подключения к Интернету.',
...
class _StringsDonationPageRu extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'FileFlow — это бесплатное приложение с открытым исходным кодом и без рекламы. Если оно вам нравится, вы можете поддержать его разработку пожертвованием.';
  @override
...
class _StringsTrayRu extends _StringsTrayEn {
  ...
  @override
  String get close => 'Выйти из FileFlow';
  @override
...
class _StringsSettingsTabGeneralRu extends _StringsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Отображать FileFlow в контекстном меню';
  @override
...
class _StringsSettingsTabOtherRu extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддержать FileFlow';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedRu
  ...
  String get description =>
      'FileFlow не может найти другие устройства без разрешения на сканирование локальной сети. Пожалуйста, предоставьте это разрешение в настройках.';
  @override
...
class _StringsDialogsSendModeHelpRu extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Получатели, у которых не установлен FileFlow, могут загрузить выбранные файлы, открыв ссылку в своем браузере.';
}
