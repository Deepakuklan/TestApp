...
class _StringsWebSharePagePtPt extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'O FileFlow utiliza um certificado assinado automaticamente. Precisa de aceitá-lo no navegador.';
  @override
...
class _StringsAboutPagePtPt extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Acerca do FileFlow';
  @override
  List<String> get description => [
        'O FileFlow é uma aplicação gratuita e de código aberto que permite partilhar ficheiros e mensagens de forma segura com dispositivos próximos através da sua rede local, sem a necessidade de uma ligação à Internet.',
...
class _StringsDonationPagePtPt extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'O FileFlow é um software gratuito, de código aberto e sem qualquer anúncio. Se gosta da aplicação, então considere apoiar o desenvolvimento com um donativo!';
  @override
...
class _StringsTrayPtPt extends _StringsTrayEn {
  ...
  @override
  String get close => 'Fechar o FileFlow';
}
...
class _StringsDialogsLocalNetworkUnauthorizedPtPt
  ...
  String get description =>
      'O FileFlow não consegue encontrar outros dispositivos sem ter a permissão para analisar a rede local. Conceda esta permissão nas definições.';
  @override
...
class _StringsDialogsSendModeHelpPtPt extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Os destinatários que não têm o FileFlow instalado podem descarregar os ficheiros selecionados abrindo o link fornecido no navegador.';
}
